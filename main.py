...
if __name__ == "__main__":
    ...
    ax1.grid(True, linestyle='--', alpha=0.3)
    Tilley = 8.027317961052654 
    plt.axhline(y=Tilley, color='#FFA500', linestyle='-', label='Tilley')
    CCR = 7.917012092274746
    plt.axhline(y=Tilley, color='#00008B', linestyle='dotted', label='CCR')
    ax1.legend(fontsize=10)
